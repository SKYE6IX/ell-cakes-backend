...
export const CartItem = list({
  ...
  fields: {
    ...
    compositions: json(), // We store the a snapshot of the composition to verify if user chose something diffrent
    customizations: json(), // Here is all about the customization the user provided along with the extra prices
